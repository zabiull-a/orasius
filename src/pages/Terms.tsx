    ...
    <section className="py-16 md:py-24">
      <div className="container max-w-3xl prose prose-slate">
        <p className="text-muted-foreground leading-relaxed">
          These terms and conditions govern your use of the IELENT website and services. By accessing or using our platform, you agree to be bound by these terms.
        </p>
        ...
        <p className="text-muted-foreground leading-relaxed">All content, materials, and resources provided through our platform are the intellectual property of IELENT and may not be reproduced without written consent.</p>
        <h2 className="font-display text-xl font-semibold text-foreground mt-8 mb-3">3. Program Registration</h2>
        <p className="text-muted-foreground leading-relaxed">Registration for programs is subject to availability. IELENT reserves the right to modify schedules, content, or delivery formats as necessary.</p>
        <h2 className="font-display text-xl font-semibold text-foreground mt-8 mb-3">4. Limitation of Liability</h2>
        <p className="text-muted-foreground leading-relaxed">IELENT shall not be liable for any indirect, incidental, or consequential damages arising from the use of our services.</p>
        <h2 className="font-display text-xl font-semibold text-foreground mt-8 mb-3">5. Contact</h2>
        <p className="text-muted-foreground leading-relaxed">For questions regarding these terms, please contact us at info@ielent.com.</p>
      </div>
    </section>
  </Layout>
);
